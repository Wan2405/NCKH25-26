...
class AutoFixer:
    ...
    def fix_until_pass(self, problem_id, initial_code, problem_description, class_name=None):
        """Vòng lặp chính: Sửa cho đến khi pass (chạy qua Docker)"""
        ...
        for iteration in range(1, self.max_iterations + 1):
            ...
            # Lưu code vào Maven project
            self._save_to_maven_project(class_name, current_code)

            # Chạy test qua Docker (Python Docker SDK)
    ...
    def _run_maven_test(self):
        """Chạy Maven test qua Docker container (Python Docker SDK)."""
        ...
        # Lưu log ra file để _process_log có thể đọc
